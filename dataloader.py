...
class Dataset(torch.utils.data.Dataset):
    ...
    def image_aug(self, image, mask):
        ...
        seq = iaa.SomeOf((1, 2),
                         [
                             iaa.OneOf([iaa.Affine(rotate=(-20, 20), name="Rotate"),
                                        iaa.Affine(scale=(0.5, 1.5), name="Scale")]),
    ...
    def __getitem__(self, index):
        ...
        mask = Image.open(os.path.join(self.data_folder, 'masks', self.image_name[index])).convert('L')
